...
// Number of tabs
  final tabs = [
    Home(),
    Center(child: PrimaryText(text: 'Order History', size: 40, color: AppColors.primary)),
    Center(child: PrimaryText(text: 'Page', size: 40, color: AppColors.primary)),
            ...
            children: [
              ...
              GestureDetector(
                ...
                currentIndex == 0 ? Padding(
                  ...
                  child: PrimaryText(text: 'Home', size: 16, color: AppColors.primaryblue, fontWeight: FontWeight.w700),
                ) : SizedBox()
                      ],
                    )),
              ),
              ...
              GestureDetector(
                ...
                currentIndex == 1 ? Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: PrimaryText(text: 'Orders', size: 16, color: AppColors.primaryblue, fontWeight: FontWeight.w700),
                ) : SizedBox()
                      ],
                    )),
              ),
              // button 3
               GestureDetector(
                ...
                currentIndex == 2 ? Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: PrimaryText(text: 'Profile', size: 16, color: AppColors.primaryblue, fontWeight: FontWeight.w700),
                ) : SizedBox()
                      ],
                    )),
              ),
              ...
              // button 4
               GestureDetector(
                ...
                currentIndex == 3 ? Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: PrimaryText(text: 'Cart', size: 16, color: AppColors.primaryblue, fontWeight: FontWeight.w700),
                ) : SizedBox()
                      ],
                    )),
              ),
